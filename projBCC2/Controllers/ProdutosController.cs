...
namespace projBCC2.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,descricao,quantidade,valor")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,descricao,quantidade,valor")] Produtos produtos)
        {
            if (id != produtos.id)
            {
                return NotFound();
